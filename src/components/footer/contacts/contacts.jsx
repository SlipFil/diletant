      ...
      <div className={s.footer_contacts}>
        <div className={s.contacts_links}>
          ...
          <div className={s.links}>
            <a href="https://twitter.com/diletant_media">
              <img src={TWI} alt="TW" />
            </a>
            <a href="https://vk.com/diletant_media">
              <img src={VK} alt="VK" />
            </a>
            <a href="https://www.facebook.com/diletant.media">
              <img src={FB} alt="FB" />
            </a>
            <a href="https://ok.ru/diletant.media">
              <img src={OK} alt="OK" />
            </a>
          </div>{" "}
        </div>
        <div className={s.contacts_other}>
          <div className={s.rubricator}>
            ...
            <ul>
              ...
              <li>
                <a href="#">
                  <img src={article} alt="TW" />
                  статьи
                </a>
              </li>
              <li>
                <a href="#">
                  <img src={tests} alt="TW" />
                  тесты
                </a>
              </li>
              <li>
                <a href="#">
                  <img src={journal} alt="TW" />
                  журналы
                </a>
              </li>
            </ul>
          ...
          <div className={s.info}>
            ...
            <ul>
              <li>
                <a href="#">правила комментирования</a>
              </li>
              <li>
